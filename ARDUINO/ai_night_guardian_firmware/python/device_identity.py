"""
Genera/persiste device_id y provisioning_key únicos del dispositivo,
y produce el QR de aprovisionamiento (sección 2 y 7 del doc de arquitectura).
"""
import json
import os
import secrets
...
def _generate_device_id():
    # Usamos un sufijo corto único; en producción real sería el MAC del BLE.
...
def load_or_create_identity():
    ...
    identity = {
        ...
        "provisioning_key": secrets.token_hex(16),  # 32 caracteres hex
        "model": MODEL,
